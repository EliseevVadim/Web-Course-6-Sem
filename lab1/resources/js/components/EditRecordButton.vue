<template>
    <div>
        <button class="btn btn-warning my-1" @click="displayForm()">
        ...
        <data-processing-window ref="form"></data-processing-window>
    </div>
</template>
...
export default {
    ...
    methods : {
        displayForm() {
            this.$refs.form.openEditingForm(this.activityId);
        }
    }
}
</script>
